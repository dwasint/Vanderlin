...
/datum/gnome_state/farming
	name = "farming"
	description = "Tending to crops"
	var/current_task = "scanning"
	var/current_target = null

/datum/gnome_state/farming/enter_state(datum/ai_controller/controller)
	current_task = "scanning"
	current_target = null

/datum/gnome_state/farming/process_state(datum/ai_controller/controller, delta_time)
...
/datum/gnome_state/farming/proc/is_water_container(obj/item/item)
	if(!istype(item, /obj/item/reagent_containers))
		return FALSE
	var/obj/item/reagent_containers/container = item
	return container.reagents?.has_reagent(/datum/reagent/water, 15)

/datum/gnome_state/farming/proc/find_water_source_nearby(datum/ai_controller/controller)
	var/mob/living/pawn = controller.pawn
...
/datum/gnome_state/farming/proc/find_seed_source_nearby(datum/ai_controller/controller)
	var/mob/living/pawn = controller.pawn
