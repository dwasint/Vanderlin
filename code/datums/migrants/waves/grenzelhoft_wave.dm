...
/datum/job/migrant/grenzelhoft_man_at_arms/after_spawn(mob/living/carbon/human/spawned, client/player_client)
	. = ..()
	spawned.adjust_skillrank(/datum/attribute/skill/combat/whipsflails, pick(1, 1, 2), TRUE)
	spawned.adjust_skillrank(/datum/attribute/skill/combat/axesmaces, pick(2, 3), TRUE)
	spawned.adjust_skillrank(/datum/attribute/skill/combat/shields, pick(0, 0, 1), TRUE)
