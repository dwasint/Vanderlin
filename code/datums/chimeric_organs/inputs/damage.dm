...
/datum/chimeric_organs/input/damage/register_triggers(mob/living/carbon/target)
	if(!target)
		return
...
/datum/chimeric_organs/input/damage/proc/calculate_potency(damage_type, amount)
