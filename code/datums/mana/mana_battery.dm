...
/obj/item/mana_battery/attack_self(mob/user, modifiers)
	...
	if (already_transferring)
		...
		if(!user.is_holding(src))
			return
		var/mana_to_draw = input(user, "How much mana do you want to draw from the battery? Soft Cap (You will lose mana when above this!): [user.mana_pool.softcap]", "Draw Mana") as num
