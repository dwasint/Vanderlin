...
/datum/ai_movement/astar/process(delta_time)
	for(var/datum/ai_controller/controller as anything in moving_controllers)
		...
		if(generate_path)
			...
			controller.movement_path = get_path_to(movable_pawn, controller.current_movement_target, /turf/proc/Distance, max_path_distance + 1, 250,  minimum_distance, id=controller.get_access())
