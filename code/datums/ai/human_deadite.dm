...
/datum/ai_controller/human_deadite
...
/datum/ai_controller/human_deadite/TryPossessPawn(atom/new_pawn)
	. = ..()
...
/datum/ai_controller/human_deadite/UnpossessPawn(destroy)
