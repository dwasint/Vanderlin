...
/datum/objective/personal/blood_splash/reward_owner()
	. = ..()
	owner.current.adjust_stat_modifier(STATMOD_GRAGGAR_BLESSING, STAT_STRENGTH, 1)
	owner.current.adjust_stat_modifier(STATMOD_GRAGGAR_BLESSING, STAT_CONSTITUTION, 1)
