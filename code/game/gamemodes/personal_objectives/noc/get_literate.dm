...
/datum/objective/personal/literacy/proc/on_skill_increased(datum/source, datum/attribute/skill/skill_ref, new_level, old_level)
	...
	if(istype(skill_ref, /datum/attribute/skill/misc/reading) && old_level == SKILL_LEVEL_NONE && new_level > SKILL_LEVEL_NONE)
		complete_objective()
...
/datum/objective/personal/literacy/reward_owner()
	. = ..()
	owner.current.adjust_skillrank(/datum/attribute/skill/labor/mathematics, 1)
