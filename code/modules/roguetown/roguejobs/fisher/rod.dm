...
/obj/item/fishingrod/afterattack(obj/target, mob/user, proximity, params)
	...
	if(prob(specialcatchprob))
		...
		if(prob(16 - skillmod - fisher.STALUC)) //you will always have a chance at this, legendary fishers got a 10% chance - their luck stat
			fishtype = pickweight(list(/obj/item/natural/fibers = 1, /obj/item/storage/belt/rogue/pouch/coins/poor = 1, /obj/item/clothing/shoes/boots/leather = 1, /obj/structure/fermentation_keg = 1, /obj/item/clothing/head/fisherhat = 1))
			difficulty = 1
			acceleration = 1
			hookwindow = 30
			maxvelocity = 1
