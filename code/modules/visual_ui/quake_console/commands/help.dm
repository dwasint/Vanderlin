...
/datum/console_command/help/help_information(obj/abstract/visual_ui_element/console_output/output)
	output.add_line("help - Display this help text")

/datum/console_command/help/execute(obj/abstract/visual_ui_element/console_output/output, list/arg_list)
