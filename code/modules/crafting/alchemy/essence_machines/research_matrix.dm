...
//TODO Make the nodes actually do something these are all testing pieces
...
/datum/thaumic_research_node/basic_transmutation
...
/datum/thaumic_research_node/arcane_theory
	name = "Arcane Theory"
	desc = "Understanding the theoretical foundations of magic."
	icon_state = "node"
	required_essences = list()
	node_x = -200
	node_y = -100

/datum/thaumic_research_node/natural_philosophy
	name = "Natural Philosophy"
	desc = "Study of the natural world and its magical properties."
	icon_state = "node"
	required_essences = list()
	node_x = 200
	node_y = -100

/datum/thaumic_research_node/elemental_binding
	name = "Elemental Binding"
	desc = "Techniques for binding elemental forces into stable forms."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/fire = 10, /datum/thaumaturgical_essence/water = 10)
	prerequisites = list(/datum/thaumic_research_node/basic_transmutation)
	node_x = -100
	node_y = 100

/datum/thaumic_research_node/essence_refinement
	name = "Essence Refinement"
	desc = "Advanced methods for purifying and concentrating thaumaturgical essences."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/earth = 15, /datum/thaumaturgical_essence/air = 10)
	prerequisites = list(/datum/thaumic_research_node/basic_transmutation)
	node_x = 100
	node_y = 100

/datum/thaumic_research_node/runic_scripts
	name = "Runic Scripts"
	desc = "Ancient writing systems that channel magical energy."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 15)
	prerequisites = list(/datum/thaumic_research_node/arcane_theory)
	node_x = -300
	node_y = 50

/datum/thaumic_research_node/void_studies
	name = "Void Studies"
	desc = "Dangerous research into the spaces between realities."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/poison = 20)
	prerequisites = list(/datum/thaumic_research_node/arcane_theory)
	node_x = -150
	node_y = 50

/datum/thaumic_research_node/botanical_alchemy
	name = "Botanical Alchemy"
	desc = "Combining plant essences with alchemical processes."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/water = 10, /datum/thaumaturgical_essence/earth = 10)
	prerequisites = list(/datum/thaumic_research_node/natural_philosophy)
	node_x = 150
	node_y = 50

/datum/thaumic_research_node/crystalline_resonance
	name = "Crystalline Resonance"
	desc = "Harnessing the natural magical properties of crystals."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/earth = 25)
	prerequisites = list(/datum/thaumic_research_node/natural_philosophy)
	node_x = 300
	node_y = 50

/datum/thaumic_research_node/advanced_enchantment
	name = "Advanced Enchantment"
	desc = "Mastery of imbuing objects with permanent magical properties."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 20, /datum/thaumaturgical_essence/poison = 15)
	prerequisites = list(/datum/thaumic_research_node/elemental_binding, /datum/thaumic_research_node/essence_refinement)
	node_x = 0
	node_y = 200

/datum/thaumic_research_node/dimensional_manipulation
	name = "Dimensional Manipulation"
	desc = "Techniques for bending space and reality."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 30, /datum/thaumaturgical_essence/poison = 25)
	prerequisites = list(/datum/thaumic_research_node/void_studies, /datum/thaumic_research_node/runic_scripts)
	node_x = -225
	node_y = 150

/datum/thaumic_research_node/living_constructs
	name = "Living Constructs"
	desc = "Creating artificial life through magical means."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/water = 20, /datum/thaumaturgical_essence/fire = 20)
	prerequisites = list(/datum/thaumic_research_node/botanical_alchemy, /datum/thaumic_research_node/crystalline_resonance)
	node_x = 225
	node_y = 150

/datum/thaumic_research_node/master_artifice
	name = "Master Artifice"
	desc = "The pinnacle of magical item creation."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 40, /datum/thaumaturgical_essence/earth = 30)
	prerequisites = list(/datum/thaumic_research_node/advanced_enchantment, /datum/thaumic_research_node/living_constructs)
	node_x = 100
	node_y = 300

/datum/thaumic_research_node/reality_shaping
	name = "Reality Shaping"
	desc = "The most dangerous art - directly altering the fabric of existence."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 50, /datum/thaumaturgical_essence/poison = 40)
	prerequisites = list(/datum/thaumic_research_node/dimensional_manipulation, /datum/thaumic_research_node/advanced_enchantment)
	node_x = -100
	node_y = 300

/datum/thaumic_research_node/transcendence
	name = "Transcendence"
	desc = "The theoretical endpoint of all thaumaturgical study."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 100, /datum/thaumaturgical_essence/fire = 50, /datum/thaumaturgical_essence/water = 50, /datum/thaumaturgical_essence/earth = 50, /datum/thaumaturgical_essence/air = 50, /datum/thaumaturgical_essence/poison = 50)
	prerequisites = list(/datum/thaumic_research_node/master_artifice, /datum/thaumic_research_node/reality_shaping)
	node_x = 0
	node_y = 400

/datum/thaumic_research_node/combat_applications
	name = "Combat Applications"
	desc = "Applying thaumaturgical knowledge to warfare."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/fire = 15, /datum/thaumaturgical_essence/air = 15)
	prerequisites = list(/datum/thaumic_research_node/elemental_binding)
	node_x = -200
	node_y = 200

/datum/thaumic_research_node/healing_arts
	name = "Healing Arts"
	desc = "Using magic to mend wounds and cure ailments."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/water = 20, /datum/thaumaturgical_essence/earth = 15)
	prerequisites = list(/datum/thaumic_research_node/essence_refinement)
	node_x = 200
	node_y = 200

/datum/thaumic_research_node/elemental_mastery
	name = "Elemental Mastery"
	desc = "Complete control over all elemental forces."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/fire = 25, /datum/thaumaturgical_essence/water = 25, /datum/thaumaturgical_essence/earth = 25, /datum/thaumaturgical_essence/air = 25)
	prerequisites = list(/datum/thaumic_research_node/combat_applications, /datum/thaumic_research_node/healing_arts)
	node_x = 0
	node_y = 350

/datum/thaumic_research_node/forbidden_knowledge
	name = "Forbidden Knowledge"
	desc = "Secrets that perhaps should remain hidden."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/poison = 50)
	prerequisites = list(/datum/thaumic_research_node/void_studies)
	node_x = -400
	node_y = 100

/datum/thaumic_research_node/pure_creation
	name = "Pure Creation"
	desc = "The power to create something from nothing."
	icon_state = "node"
	required_essences = list(/datum/thaumaturgical_essence/magic = 60, /datum/thaumaturgical_essence/earth = 40)
	prerequisites = list(/datum/thaumic_research_node/crystalline_resonance)
	node_x = 400
	node_y = 100
