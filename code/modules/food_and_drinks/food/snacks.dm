...
/obj/item/reagent_containers/food/snacks/add_initial_reagents()
	if(nutrition)
		if(vitamin)
			reagents.add_reagent(/datum/reagent/consumable/nutriment, nutrition * 0.75, length(tastes) ? list("tastes" = tastes) : null)
			reagents.add_reagent(/datum/reagent/consumable/nutriment/vitamin, nutrition * 0.25, length(tastes) ? list("tastes" = tastes) : null)
		else
