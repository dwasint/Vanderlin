...
/mob/living/simple_animal/hostile/retaliate/voidstoneobelisk/MoveToTarget(list/possible_targets)
...
/mob/living/simple_animal/hostile/retaliate/voidstoneobelisk/proc/Activate(atom/target)
...
/mob/living/simple_animal/hostile/retaliate/voidstoneobelisk/proc/fire_laser()
...
/mob/living/simple_animal/hostile/retaliate/voidstoneobelisk/proc/extinguish_laser()
	if(!length(beam_parts))
		return FALSE
