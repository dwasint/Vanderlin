...
/datum/outfit/greater_skeleton/pre_equip(mob/living/carbon/human/H) //equipped onto Summon Greater Undead player skeletons only after the mind is added
	...
	H.adjust_skillrank(/datum/attribute/skill/craft/carpentry, 1, TRUE)
	H.adjust_skillrank(/datum/attribute/skill/craft/masonry, 1, TRUE)
	H.adjust_skillrank(/datum/attribute/skill/craft/crafting, 1, TRUE)
	H.adjust_skillrank(/datum/attribute/skill/misc/sewing, 1, TRUE)
...
/mob/living/carbon/human/species/skeleton/npc/warrior/skilled/proc/configure_mind()
	...
	adjust_skillrank(/datum/attribute/skill/combat/polearms, 2, TRUE)
	adjust_skillrank(/datum/attribute/skill/combat/swords, 2, TRUE)
	...
	adjust_skillrank(/datum/attribute/skill/combat/knives, 2, TRUE)
	adjust_skillrank(/datum/attribute/skill/combat/axesmaces, 2, TRUE)
