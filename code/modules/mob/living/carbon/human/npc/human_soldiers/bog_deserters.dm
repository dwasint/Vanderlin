...
/datum/outfit/job/human/northern/bog_deserters/pre_equip(mob/living/carbon/human/H)
	...
	//skill Stuff
	H.adjust_skillrank(/datum/attribute/skill/combat/axesmaces, 4, TRUE) //NPCs do not get these skills unless a mind takes them over, hopefully in the future someone can fix
	...
	H.adjust_skillrank(/datum/attribute/skill/misc/athletics, 3, TRUE)
