...
/datum/species/kobold
	...
	specstats_m = list(STAT_STRENGTH = -4, STAT_PERCEPTION = -2, STAT_INTELLIGENCE = -2, STAT_CONSTITUTION = -4, STAT_ENDURANCE = 2, STAT_SPEED = 2, STAT_FORTUNE = 0)
	specstats_f = list(STAT_STRENGTH = -4, STAT_PERCEPTION = -2, STAT_INTELLIGENCE = -2, STAT_CONSTITUTION = -4, STAT_ENDURANCE = 2, STAT_SPEED = 2, STAT_FORTUNE = 0)
