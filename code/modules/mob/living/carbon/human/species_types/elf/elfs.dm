...
/datum/species/elf/snow
	...
	specstats_m = list(STAT_STRENGTH = -1, STAT_PERCEPTION = 1, STAT_INTELLIGENCE = 1, STAT_CONSTITUTION = -1, STAT_ENDURANCE = 0, STAT_SPEED = 2, STAT_FORTUNE = 0)
	specstats_f = list(STAT_STRENGTH = -1, STAT_PERCEPTION = 1, STAT_INTELLIGENCE = 1, STAT_CONSTITUTION = -1, STAT_ENDURANCE = 0, STAT_SPEED = 2, STAT_FORTUNE = 0)
