...
/datum/chemical_reaction/ichor_of_mending
	...
	id = "ichor_of_mending"
	required_reagents = list(/datum/reagent/medicine/healthpot = 5, /datum/reagent/ash = 3, /datum/reagent/medicine/rosawater = 5)
...
/datum/chemical_reaction/ashbinders_salve
	...
	id = "ashbinders_salve"
	required_reagents = list(/datum/reagent/ash = 5, /datum/reagent/medicine/rosawater = 5, /datum/reagent/water = 5)
...
/datum/chemical_reaction/vitalroot_draught
	...
	required_reagents = list(/datum/reagent/medicine/antidote = 5, /datum/reagent/water = 5, /datum/reagent/medicine/rosawater = 5)
...
/datum/chemical_reaction/tombsilt_tincture
	...
	required_reagents = list(/datum/reagent/ash = 5, /datum/reagent/medicine/antidote = 5, /datum/reagent/mercury = 3)
...
/datum/chemical_reaction/mirewort_compress
	...
	required_reagents = list(/datum/reagent/water/gross = 5, /datum/reagent/medicine/antidote = 5, /datum/reagent/ash = 3)
...
/datum/chemical_reaction/woundwrack_oil
	name = "Woundwrack Oil"
	id = "woundwrack_oil"
	required_reagents = list(/datum/reagent/medicine/rosawater = 5, /datum/reagent/ash = 5, /datum/reagent/medicine/healthpot = 3)
...
/datum/chemical_reaction/pale_serum
	name = "Pale Serum"
	id = "pale_serum"
	required_reagents = list(/datum/reagent/water = 5, /datum/reagent/mercury = 3, /datum/reagent/medicine/antidote = 5)
...
/datum/chemical_reaction/crystalline_lymph
	...
	required_reagents = list(/datum/reagent/water = 5, /datum/reagent/medicine/manapot = 5, /datum/reagent/medicine/antidote = 3)
...
/datum/chemical_reaction/bloodelder_wine
	...
	id = "bloodelder_wine"
	required_reagents = list(/datum/reagent/blood = 5, /datum/reagent/medicine/healthpot = 5, /datum/reagent/water = 5)
...
/datum/chemical_reaction/nervebind_extract
	...
	required_reagents = list(/datum/reagent/medicine/soporpot = 5, /datum/reagent/water = 5, /datum/reagent/ash = 3)
...
/datum/chemical_reaction/sunpetal_decoction
	...
	required_reagents = list(/datum/reagent/medicine/antidote = 5, /datum/reagent/medicine/rosawater = 5, /datum/reagent/water = 3)
...
/datum/chemical_reaction/stonevein_broth
	...
	id = "stonevein_broth"
	required_reagents = list(/datum/reagent/medicine/healthpot = 5, /datum/reagent/mercury = 3, /datum/reagent/water = 5)
...
/datum/chemical_reaction/fever_oil
	name = "Fever Oil"
	id = "fever_oil"
	required_reagents = list(/datum/reagent/medicine/antidote = 5, /datum/reagent/toxin/plasma = 2, /datum/reagent/water = 5)
...
/datum/chemical_reaction/witchknit_paste
	...
	id = "witchknit_paste"
	required_reagents = list(/datum/reagent/ash = 5, /datum/reagent/medicine/rosawater = 5, /datum/reagent/water = 3)
...
/datum/chemical_reaction/mindclear_tonic
	...
	id = "mindclear_tonic"
	required_reagents = list(/datum/reagent/water = 5, /datum/reagent/medicine/manapot = 5, /datum/reagent/mercury = 3)
...
/datum/chemical_reaction/marrowbrew
	name = "Marrowbrew"
	id = "marrowbrew"
	required_reagents = list(/datum/reagent/medicine/healthpot = 5, /datum/reagent/medicine/stampot = 5, /datum/reagent/water = 3)
...
/datum/chemical_reaction/spiritwood_elixir
	...
	required_reagents = list(/datum/reagent/medicine/healthpot = 5, /datum/reagent/medicine/rosawater = 5, /datum/reagent/medicine/manapot = 5)
...
/datum/chemical_reaction/coldvein_compress
	...
	required_reagents = list(/datum/reagent/water = 5, /datum/reagent/medicine/antidote = 5, /datum/reagent/mercury = 3)
...
/datum/chemical_reaction/ashwarden_brew
	name = "Ashwarden Brew"
	id = "ashwarden_brew"
	required_reagents = list(/datum/reagent/ash = 5, /datum/reagent/medicine/antidote = 5, /datum/reagent/toxin/plasma = 2)
...
/datum/chemical_reaction/thornmorrow_tincture
	...
	required_reagents = list(/datum/reagent/medicine/rosawater = 5, /datum/reagent/medicine/antidote = 5, /datum/reagent/water = 5)
...
/datum/chemical_reaction/blistergall
	name = "Blistergall"
	id = "blistergall"
	required_reagents = list(/datum/reagent/toxin/acid = 3, /datum/reagent/toxin/venom = 5, /datum/reagent/water = 5)
...
/datum/chemical_reaction/ashfall_dust
	name = "Ashfall Dust"
	id = "ashfall_dust"
	required_reagents = list(/datum/reagent/ash = 7, /datum/reagent/toxin/plasma = 3)
	results = list(/datum/reagent/poison/ashfall_dust = 10)
	mix_message = "The ash absorbs the plasma, solidifying into a fine scorched powder."
...
/datum/chemical_reaction/rotwater
	name = "Rotwater"
	id = "rotwater"
	required_reagents = list(/datum/reagent/water/gross = 7, /datum/reagent/toxin/amatoxin = 3, /datum/reagent/toxin/bad_food = 3)
...
/datum/chemical_reaction/hexblood_poison
	...
	id = "hexblood_poison"
	required_reagents = list(/datum/reagent/blood = 5, /datum/reagent/toxin/venom = 5, /datum/reagent/ash = 3)
...
/datum/chemical_reaction/mirrorwaste
	name = "Mirrorwaste"
	id = "mirrorwaste"
	required_reagents = list(/datum/reagent/mercury = 5, /datum/reagent/toxin/manabloom_juice = 5, /datum/reagent/water = 3)
...
/datum/chemical_reaction/ironblight
	name = "Ironblight"
	id = "ironblight"
	required_reagents = list(/datum/reagent/mercury = 5, /datum/reagent/toxin/acid = 5, /datum/reagent/toxin/plasma = 2)
...
/datum/chemical_reaction/blinding_spore
	name = "Blinding Spore"
	id = "blinding_spore"
	required_reagents = list(/datum/reagent/toxin/amatoxin = 5, /datum/reagent/ash = 7)
...
/datum/chemical_reaction/heatcramp_oil
	name = "Heatcramp Oil"
	id = "heatcramp_oil"
	required_reagents = list(/datum/reagent/toxin/venom = 5, /datum/reagent/toxin/fyritiusnectar = 3, /datum/reagent/water = 5)
...
/datum/chemical_reaction/mirelung_brew
	name = "Mirelung Brew"
	id = "mirelung_brew"
	required_reagents = list(/datum/reagent/water/gross = 5, /datum/reagent/toxin/amatoxin = 5, /datum/reagent/toxin/bad_food = 3)
...
/datum/chemical_reaction/quietdeath
	name = "Quietdeath"
	id = "quietdeath"
	required_reagents = list(/datum/reagent/toxin/amanitin = 5, /datum/reagent/water = 7, /datum/reagent/mercury = 3)
...
/datum/chemical_reaction/soulbane_ichor
	name = "Soulbane Ichor"
	id = "soulbane_ichor"
	required_reagents = list(/datum/reagent/toxin/venom = 5, /datum/reagent/blood/putrid = 5, /datum/reagent/toxin/amatoxin = 5)
