...
/datum/plant_def/rice/set_genetic_tendencies(datum/plant_genetics/base_genetics)
	base_genetics.water_efficiency = TRAIT_GRADE_POOR  // Loves water/flooded conditions
