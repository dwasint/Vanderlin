...
/client/proc/enable_debug_verbs()
	...
	add_verb(src, /client/proc/disable_debug_verbs, GLOB.admin_verbs_debug_mapping)
...
/client/proc/disable_debug_verbs()
	...
	remove_verb(src, /client/proc/disable_debug_verbs, GLOB.admin_verbs_debug_mapping)
