...
/mob/living/carbon/human/proc/turn_to_minion(mob/living/carbon/human/master, ckey)
	...
	clamped_adjust_skillrank(/datum/attribute/skill/combat/axesmaces, 2, 3, TRUE)
	clamped_adjust_skillrank(/datum/attribute/skill/combat/crossbows, 2, 3, TRUE)
	clamped_adjust_skillrank(/datum/attribute/skill/combat/wrestling, 1, 3, TRUE)
	clamped_adjust_skillrank(/datum/attribute/skill/combat/unarmed, 1, 3, TRUE)
	clamped_adjust_skillrank(/datum/attribute/skill/combat/swords, 2, 3, TRUE)
